...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Depertment Name");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "EEE", "Textile", "LLB", "GBS", "English" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Descrite Mathematics", "Structure Progr.", "OOP", "DLD", "Algorithm", "EAP", "AP", "Physics 1", "Physics 2", "Chemistry " }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Tiktokers" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into student(Idno,name,dept,course,gender) values('"+id+"','"+name+"','"+dept+"','"+course+"','"+gender+"')");
